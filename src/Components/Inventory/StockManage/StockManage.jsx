    ...
    <>
      ...
      <div className="m-5 d-flex justify-content-around">
        <div className="w-50">
          ...
          <button onClick={()=>reduceQty(product._id)} className="btn btn-success">Delivered</button>
        </div>
        <div>
          <h3>Restock Your product:: <span className="fw-bold text-primary">{product?.quantity}</span></h3>
